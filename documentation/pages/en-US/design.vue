...
<template>
  <div>
    ...
    <el-row :gutter="14" class="cards">
      <el-col :xs="12" :sm="6">
        <div class="card">
          <!--<img src="~documentation/assets/images/consistency.png" alt="Consistency">-->
          <h4>Consistency</h4>
          <span></span>
        </div>
      </el-col>
      <el-col :xs="12" :sm="6">
        <div class="card">
          <!--<img src="~documentation/assets/images/feedback.png" alt="Feedback">-->
          <h4>Feedback</h4>
          <span></span>
        </div>
      </el-col>
      <el-col :xs="12" :sm="6">
        <div class="card">
          <!--<img src="~documentation/assets/images/efficiency.png" alt="Efficiency">-->
          <h4>Efficiency</h4>
          <span></span>
        </div>
      </el-col>
      <el-col :xs="12" :sm="6">
        <div class="card">
          <!--<img src="~documentation/assets/images/controllability.png" alt="Controllability">-->
