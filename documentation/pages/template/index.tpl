...
<template>
  <div>
    <div class="banner">
      ...
      <img class="banner-stars" src="~documentation/assets/images/stars.png" alt="Element">
      <div class="container">
        ...
        <img src="~documentation/assets/images/banner-bg.svg" alt="Element">
      </div>
    </div>
    <div class="cards">
      <ul class="container">
        <li>
          <div class="card">
            <img src="~documentation/assets/images/guide.png" alt="">
            <h3><%= 3 ></h3>
            <p><%= 4 ></p>
            <router-link
              active-class="active"
        ...
        <li>
          <div class="card">
            <img src="~documentation/assets/images/component.png" alt="">
            <h3><%= 6 ></h3>
            <p><%= 7 ></p>
            <router-link
              active-class="active"
        ...
        <li>
          <div class="card">
            <img src="~documentation/assets/images/resource.png" alt="">
            <h3><%= 8 ></h3>
            <p><%= 9 ></p>
            <router-link
              active-class="active"
