    ...
    <div class="block">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="15" class="nav-demos">
          <img src="~documentation/assets/images/navbar_1.png" alt="<%= 7 >" @click="enlarge(846, $event)">
          <h5><%= 7 ></h5>
          <p><%= 8 ></p>
          <img src="~documentation/assets/images/navbar_2.png" alt="<%= 9 >" @click="enlarge(846, $event)">
          <h5><%= 9 ></h5>
          <p><%= 10 ></p>
          <img src="~documentation/assets/images/navbar_3.png" alt="<%= 11 >" @click="enlarge(846, $event)">
          <h5><%= 11 ></h5>
          <p><%= 12 ></p>
        </el-col>
      </el-row>
