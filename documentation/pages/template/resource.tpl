  ...
  <div class="page-container page-resource">
    ...
    <div class="cards">
      <ul class="container">
        <li>
          <div class="card">
            <img src="~documentation/assets/images/Axure-Components.svg" alt="">
            <h3><%= 3 ></h3>
            <p><%= 4 ></p>
        ...
        <li>
          <div class="card">
            <img src="~documentation/assets/images/Sketch-Template.svg" alt="">
            <h3><%= 6 ></h3>
            <p><%= 7 ></p>
        ...
        <li>
          <div class="card">
            <img src="~documentation/assets/images/Module.svg" alt="">
            <h3><%= 8 ></h3>
            <p><%= 9 ></p>
