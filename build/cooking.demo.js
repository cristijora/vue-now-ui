...
cooking.set({
  entry: isProd ? {
    docs: './documentation/entry.js',
    'now-ui': './src/index.js'
  } : (isPlay ? './documentation/play.js' : './documentation/entry.js'),
  dist: './documentation/now-ui/',
  template: [
    {
      template: './documentation/index.tpl',
      filename: './index.html',
...
cooking.add('plugin.CopyWebpackPlugin', new CopyWebpackPlugin([
  { from: 'documentation/versions.json' }
]));
